...
const TopRatingCard: React.FC<TopRatingCardProps> = ({place,username,points,prize}) => {
  return (
    <>
  <div className="w-[244px] h-[357px] self-start flex flex-col items-center">
  <div className="w-[110px] h-[100px] shadow-[0_0_40px_15px_rgba(255,255,255,0.2)]
                rounded-xl  outline outline-1 outline-[#C0C0C0] outline-opacity-20 
                backdrop-blur-md backdrop-brightness-125 pointer-events-none">
<Image  
...
/>
    ...
    <div className="text-white tracking-wider font-semibold
                      text-[24px] font-tektur mt-2 pointer-events-none">{username}
    </div> 

    <div className='w-[244px] h-[223px] shadow-[inset_0_4px_10px_rgba(0,0,0,0.30)] rounded-3xl
                    bg-gradient-to-b from-[#252937] to-[#0E0C15] via-[#252937] via-[0%] to-[80%]
