...
const AssetCard: React.FC<CardProps> = ({ assetPath, type, onUse }) => {
  ...
  return (
    <div className='w-[185px] h-[215px] outline outline-1 outline-[#212023] rounded-[10px] mr-5 mb-4 flex flex-col hover:outline-[#B3FFED] hover:outline-2 transition-all'>
      {/* Image Container */}
      <div className='w-full h-[142px] outline outline-1 outline-[#212023] rounded-t-[10px] relative overflow-hidden'>
        <Image
          ...
          onError={(e) => {
            ...
            target.src = type === 'pfp' ? defaultPfp : defaultBg;
