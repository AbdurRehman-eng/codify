...
function PaymentCard({text, subText, src, items, width, style}: {text: string, subText: string, src: string, items: string[], width: string, style: string}) {
    const spaceY = '10';
    return ( 
        <div className={`hover:h-[57vh] hover:w-[39vh] transition-all p-[4.6vh] relative h-[56.5vh] space-y-[1.6vh] w-[38.6vh] bg-primary flex border-[0.08vh] border-stroke border-opacity-50 items-center justify-center flex-col rounded-[3.16vh]`}>
