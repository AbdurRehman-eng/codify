...
function HeroSection() {
    return ( 
        <div className="h-screen w-full relative border-2 border-border overflow-hidden">
            {/* Background Images */}
            <Image
            ...
            <Button children={"Get Started"} top="310px" left="520px" pos="absolute w-[181px] h-[59px]"/>
