  ...
  return (
    <div className=' w-[320px] h-[482px] mt-[144px] ml-[66px] mb-[40px] flex flex-col items-center'>
      ...
      <div className='w-full h-[107px] rounded-[12px] relative'>
        <Image
          src="/assets/images/Profile/SideBar/user_background.jpg"
          alt="UserBackground"
          width={320}
          height={107}
      ...
      <div className='w-[96px] h-[89px] rounded-[100px] outline outline-2 outline-black -mt-12 flex items-center justify-center z-10'>
        <Image
          src="/assets/images/Profile/SideBar/PFP2.png"
          alt="Profile Image"
          width={96} 
          height={89}
      ...
      <div className='text-[#9A999E] font-tektur font-light text-[12px]
      h-fit w-[294px] leading-[16px] mt-2'>Lorem Ipsum has been the industry's 
     ...
     but also the leap into. </div>
      ...
      <div className='w-full  h-[26px] mt-6 font-tektur flex font-medium text-[12px] ml-2'>
        ...
        <Image
          ...
          quality={100}
        />
           <p className='mt-1'> Follow</p></button>
        ...
        <Image
          ...
          quality={100}
        />
           <p className='mt-1 text-[#B3FFED]'> Edit Bio</p></button>
      ...
      <Image
          ...
          quality={100}/>
        <div className=' w-full h-full text-[12px] font-light
         font-tektur text-[#9A999E] mt-[13px] ml-[4px] leading-[18px]'> 
         No. of tournaments participated:  <span className='ml-3'>10</span><br />Ranked in Top 3:
         <span className='ml-3 text-[#B3FFED]'>03</span></div>
      </div>
    </div>
  );
};
